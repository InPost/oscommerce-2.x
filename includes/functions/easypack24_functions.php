...
function easypack24_connect($params = array()){
...
function easypack24_generate($type = 1, $length){
...
function easypack24_getParcelStatus(){
    $status[0] = array(
        'id' => 'Created',
        'text' => 'Created'
    );
...
function easypack24_calculateDimensions($product_dimensions = array(), $config = array()){
        $parcelSize = 'A';
        $is_dimension = true;
